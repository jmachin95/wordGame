...
- Description: The program is a Java Word Game which prompts a user for input, applies rules to the input 
               ...
               prompted to enter another word until a valid input is received. Words containing capital letters
...
public class wordGame {
    static String[] words = new String[31]; //String array to store all validated words
         ...
         do{
            ...
            if (startInput.equals("yes")) {
                System.out.println("Rules:\n1. You must enter a word which begins with the same character" +
                        " that the previous word ended with.\n2. You must not enter a word that you have entered before, if so the game will end.\n3. " +
                        ...
                        + " and will be displayed at the end of the game." + "\nExample: empathy, year, real..." + "\nThe game starts here:" + "\n-------------");
                gameRunInt = 1;
                runWhile = 10;
            }
